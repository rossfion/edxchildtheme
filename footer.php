        ...
        <div class="footer-credits">
            ...
            <p class="powered-by-wordpress">
                <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'edxchildtheme' ) ); ?>">
                    <?php _e( 'Powered by WordPress', 'edxchildtheme' ); ?>
                </a>
        ...
        <a class="to-the-top" href="#site-header">
            <span class="to-the-top-long">
                <?php
                    ...
                    printf( __( 'To the top %s', 'edxchildtheme' ), '<span class="arrow" aria-hidden="true">&uarr;</span>' );
                ?>
            </span><!-- .to-the-top-long -->
            <span class="to-the-top-short">
                <?php
                    /* translators: %s: HTML character for up arrow. */
                    printf( __( 'Up %s', 'edxchildtheme' ), '<span class="arrow" aria-hidden="true">&uarr;</span>' );
                ?>
